...
fn test_regex_char_matches() {
    ...
    assert!(TestRegexChar::matches(&mut hay));
    assert!(hay.is_end());
}
...
fn test_regex_byte_matches() {
    ...
    assert!(TestRegexByte::matches(&mut hay));
    assert!(hay.is_end());
}
...
fn test_regex_complex_matches() {
    ...
    assert!(TestRegexComplex::matches(&mut hay));
    assert!(hay.is_end());
}
...
fn test_regex_multiple_attempts() {
    ...
    assert!(TestRegexChar::matches(&mut hay1));
    assert!(TestRegexChar::matches(&mut hay2));
}
...
fn test_anon_regex_multiple_attempts() {
    ...
    assert!(regex.matches(&mut hay1));
    assert!(regex.matches(&mut hay2));
}
